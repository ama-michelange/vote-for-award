			...
			<div class="form-group">
				<label for="inputProperTitle">Titre propre
					<span class="btn btn-xs btn-link" data-rel="popover" data-original-title="Titre propre" 
						data-content="Si l'album fait partie d'une série, titre propre de l'album dans la série"><i class="glyphicon glyphicon-question-sign"></i>
					</span> 
				</label>
			...
			<div class="form-group">
				<div class="pull-right">
					<?php if(trim($this->oDoc->doc_id)==false):?>
						<a class="btn btn-default" href="<?php echo $this->getLink('docs::index') ?>"><i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;Annuler</a>
					<?php else:?>
						<a class="btn btn-default" href="<?php echo $this->getLink('docs::read',array('id'=>$this->oDoc->doc_id)) ?>"><i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;Annuler</a>
					<?php endif;?>
