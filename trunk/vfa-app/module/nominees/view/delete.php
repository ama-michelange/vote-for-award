	...
	<div class="panel-footer clearfix">
		<form action="" method="POST" >
			...
			<div class="pull-right">
				<a class="btn btn-default" href="<?php echo $this->getLink('nominees::index',array('idAward'=>$this->oViewShow->oAward->award_id)) ?>"><i class="glyphicon glyphicon-remove with-text"></i>Annuler</a>
