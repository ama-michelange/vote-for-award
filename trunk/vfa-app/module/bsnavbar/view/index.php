...
if (is_array($sLink)) :
					...
					?>
					<li class="dropdown<?php if(true==$active) : echo ' active'; endif;?>"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"><?php echo $sLibelle ?> <b class="caret"></b></a>
				...
				<?php else:?>
					<li <?php if(_root::getParamNav()==$sLink) : echo 'class="active"'; endif;?>><a
					href="<?php echo $this->getLink($sLink) ?>"><?php echo $sLibelle ?></a></li>
				<?php endif;?>
			<?php endforeach;?>
			</ul>
			...
			<?php if(_root::getAuth()->isConnected()):?>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
						class="glyphicon glyphicon-user glyphicon glyphicon-white"></i> <small><?php echo $oUser->username;?></small>
						<b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="#registration-users"><i class="glyphicon glyphicon-user"></i> Compte</a></li>
						<li><a href="<?php echo $this->getLink('bsnavbar::logout')?>"><i
								class="glyphicon glyphicon-remove-sign"></i> Déconnexion</a></li>
					</ul></li>
			<?php else:?>
				<li><a href="#myModal" data-toggle="modal"><i
						class="glyphicon glyphicon-user glyphicon glyphicon-white"></i> &nbsp;Connexion</a></li>
			<?php endif;?>
			</ul>
		</div>
	</div>
