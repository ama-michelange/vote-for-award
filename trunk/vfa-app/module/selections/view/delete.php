<div class="panel panel-danger">
	<div class="panel-heading">
		<h3 class="panel-title">Supprimer <?php echo $this->oViewShow->oSelection->toString() ?></h3>
	</div>
	...
	<div class="panel-footer clearfix">
		<form action="" method="POST">
			...
			<div class="pull-right">
				<a class="btn btn-default" href="<?php echo $this->getLink('selections::read',array('id'=>_root::getParam('id'))) ?>"><i
