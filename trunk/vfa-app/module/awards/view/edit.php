			...
			<?php else:?>
				<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'name')?>">
					<label for="inputName">Nom
						<span class="btn btn-xs btn-link" data-rel="popover" data-original-title="Nom" 
							data-content="Le nom du prix à afficher.">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'type')?>">
							<label>Type
								<span class="btn btn-xs btn-link" data-rel="popover" data-original-title="Type" 
									data-content="Les albums d'un 'Prix' sont destinés aux lecteurs inscris. Les albums d'une 'Présélection' sont destinés au comité de sélection.">
									<i class="glyphicon glyphicon-question-sign"></i>
								</span>
							</label>
							<div>
					...
					<div class="col-sm-6">
						<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'public')?>">
							<label>Visibilité
								<span class="btn btn-xs btn-link" data-rel="popover" data-original-title="Visibilité" style="font-weight: normal;"
									data-content="En privé, le prix est visible uniquement par les lecteurs inscris à ce prix. En public, les résultats du prix sont, en plus, visibles par tous les internautes visitant le site.">
									<i class="glyphicon glyphicon-question-sign"></i>
								</span>
							</label>
							<div>
								<label class="radio-inline" for="inputPublic">
									<input type="radio" id="inputPublic" name="public" value="1" <?php if($this->oAward->public): echo 'checked'; endif; ?> />
									Public
								</label>
								...
								<span class="help-block"><?php echo plugin_validation::show($this->tMessage, 'public')?></span>
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'start_date')?>">
							<label for="inputDateBegin">Date de début
								<span class="btn btn-xs btn-link" data-rel="popover" data-original-title="Date de début" 
							...
							<span class="help-block"><?php echo plugin_validation::show($this->tMessage, 'start_date')?></span>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'end_date')?>">
							<label for="inputDateEnd">Date de fin
								<span class="btn btn-xs btn-link" data-rel="popover" data-original-title="Date de fin" 
							...
							<span class="help-block"><?php echo plugin_validation::show($this->tMessage, 'end_date')?></span>
						</div>
					</div>
				</div>
			<?php endif;?>
