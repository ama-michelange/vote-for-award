		...
		<div class="modal-content">
			<form class="form-horizontal" action="" method="POST">
				<div class="modal-header">
					...
					<h3>Vous souhaitez refuser l'inscription ...</h3>
				</div>
...
<div class="alert alert-warning clearfix">
	<p><?php echo plugin_validation::show($this->tMessage, 'token')?>
		<a class="btn btn-sm btn-warning pull-right" href="<?php echo $this->getLink('autoreg::index',array('id'=>$this->oConfirm->invitation_id ,'key'=>$this->oConfirm->invitation_key)) ?>">Fermer</a></p>
</div>		
<?php else:?>
...
<div class="panel panel-default">
	...
	<div class="panel-body panel-condensed">
			<p>kljh azejh qsdf qspdoifu âzef razer tq^sd$f$o qsd fazpoue qusd gqpsoud gfqpsd gqs dgpoqus pogu qsdpof opazuef pouqsdf poauz</p>			
		<div class="row">
			<div class="col-md-4">
					...
					<div class="panel panel-default panel-inner">
						...
						<div class="panel-body">
							<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'cf_login')?>">
								<label for="cfLogin">Nom d'utilisateur</label>
								<input class="form-control" type="text" id="cfLogin" name="cf_login" placeholder="Votre nom d'utilisateur ou pseudo" />
			...
			<div class="col-md-8">
				<form id="toRegistry" action="" method="POST">
					...
					<div class="panel panel-info panel-inner">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'username')?>">
										...
										<input class="form-control" type="text" id="username" name="username" value="<?php echo $this->oConfirm->username ?>" placeholder="Votre nom d'utilisateur ou pseudo" />
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'email')?>">
										...
										<input class="form-control" type="text" id="email" name="email" value="<?php echo $this->oConfirm->email ?>" placeholder="Votre Email" />
								...
								<div class="col-sm-6">
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'email_bis')?>">
										...
										<input class="form-control" type="text" id="email_bis" name="email_bis" value="<?php echo $this->oConfirm->email_bis ?>" placeholder="Confirmez votre Email" />
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'password')?>">
										...
										<input class="form-control" type="password" id="password" name="password" value="<?php echo $this->oConfirm->password ?>" placeholder="Votre mot de passe" />
										<span class="help-block"><?php echo plugin_validation::show($this->tMessage, 'password')?></span>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'password_bis')?>">
										<label for="password_bis">Confirmation du mot de passe</label> 
										<input class="form-control" type="password" id="password_bis" name="password_bis" value="<?php echo $this->oConfirm->password_bis ?>" placeholder="Confirmez votre mot de passe" />
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'last_name')?>">
										...
										<input class="form-control" type="text" id="inputLastName" name="last_name" value="<?php echo $this->oConfirm->last_name ?>" placeholder="Votre nom de famille" />
								...
								<div class="col-sm-6">
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'first_name')?>">
										...
										<input class="form-control" type="text" id="inputFirstName" name="first_name" value="<?php echo $this->oConfirm->first_name ?>" placeholder="Votre prénom" />
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'birthyear')?>">
										...
										<select class="form-control" id="inputBirthyear" name="birthyear" data-placeholder="Sélectionner votre année de naissance">
											<option></option>
								...
								<div class="col-sm-6">
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'birthyear')?>">
										<label for="inputBirthyear">Année de naissance</label>
										<input class="form-control" type="text" id="inputBirthyear" name="birthyear" value="<?php echo $this->oConfirm->birthyear ?>" />
										<span class="help-block"><?php echo plugin_validation::show($this->tMessage, 'birthyear')?></span>
									</div>
								</div>
								*/?>
									...
									<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'gender')?>">
										...
										<div>
											<label class="radio-inline" for="inputHomme">
												<input type="radio" id="inputHomme" name="gender" value="M" <?php if('M'==$this->oConfirm->gender): echo 'checked'; endif; ?> />
												Homme
											</label>
											<label class="radio-inline" for="inputFemme">
												<input type="radio" id="inputFemme" name="gender" value="F" <?php if('F'==$this->oConfirm->gender): echo 'checked'; endif; ?> />
												Femme
											</label>
						...
						<div class="panel-footer clearfix">
							<div class="pull-right">
								<button type="submit" class="btn btn-info" name="action" value="toRegistry"><i class="glyphicon glyphicon-ok with-text"></i>S'enregistrer</button>
							</div>
						</div>
					</div>
				</form>
