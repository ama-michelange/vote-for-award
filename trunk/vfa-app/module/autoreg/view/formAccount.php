	...
	<div class="panel panel-info panel-inner">
		<div class="panel-heading">
			<h3 class="panel-title">
				Nouveau sur <?php echo _root::getConfigVar('vfa-app.title') ?> ?
				<small>Enregistrez-vous</small>
			</h3>
		</div>
				...
				<div class="col-sm-6">
					<div
						...
						<label for="login">Nom d'utilisateur</label> <input class="form-control" type="text"
																							 ...
																							 placeholder="Votre nom d'utilisateur ou pseudo"/> <span
				...
				<div class="col-sm-6">
					<div
						...
						<label for="email">Email</label> <input class="form-control" type="text" id="email"
																			 name="email" value="<?php echo $this->oConfirm->email ?>"
																			 placeholder="Votre Email"/> <span
				...
				<div class="col-sm-6">
					<div
						...
						<label for="email_bis">Confirmation de l'email</label> <input class="form-control"
																										  ...
																										  value="<?php echo $this->oConfirm->email_bis ?>"
																										  placeholder="Confirmez votre Email"/> <span
				...
				<div class="col-sm-6">
					<div
						...
						<label for="password">Mot de passe</label> <input class="form-control" type="password"
																						  ...
																						  value="<?php echo $this->oConfirm->password ?>"
																						  placeholder="Votre mot de passe"/> <span
							class="help-block"><?php echo plugin_validation::show($this->tMessage, 'password') ?></span>
					</div>
				</div>
				<div class="col-sm-6">
					<div
						...
						<label for="password_bis">Confirmation du mot de passe</label> <input class="form-control"
																													 type="password" id="password_bis"
																													 name="password_bis"
																													 value="<?php echo $this->oConfirm->password_bis ?>"
																													 placeholder="Confirmez votre mot de passe"/> <span
							class="help-block"><?php echo plugin_validation::show($this->tMessage, 'password_bis') ?></span>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<div
						...
						<label for="inputLastName">Nom de famille</label> <input class="form-control" type="text"
																									...
																									value="<?php echo $this->oConfirm->last_name ?>"
																									placeholder="Votre nom de famille"/> <span
				...
				<div class="col-sm-6">
					<div
						...
						<label for="inputFirstName">Prénom</label> <input class="form-control" type="text"
																						  ...
																						  value="<?php echo $this->oConfirm->first_name ?>"
																						  placeholder="Votre prénom"/> <span
