...
_root::setConfigVar('tLangue', array(
		...
		// Rôles
		'role.board' => 'Membre du comité de sélection', 'role.bookseller' => 'Libraire', 'role.organizer' => 'Organisateur',
		'role.owner' => 'Propriétaire', 'role.reader' => 'Lecteur', 'role.responsible' => 'Correspondant',

		// Groupes
		'group.board' => 'Comité de sélection', 'group.bookseller' => 'Libraires', 'group.reader' => 'Lecteurs',

		'title.users' => 'Utilisateurs', 'title.users.list' => 'Tous les utilisateurs', 'title.users.listBoardGroup' => 'Comité de sélection',
		'title.users.listDetailed' => 'Tous les utilisateurs détaillés', 'title.users.listResponsibleGroup' => 'Correspondants',

		'menu.users' => 'Comptes',

		// Messages d'erreurs
		'token' => '<strong>Page invalide !</strong><p>Une page de saisie n\'est valable qu\'un certain temps qui est dépassé.</p>',
		'isNotEmptyKO' => 'Saisie obligatoire !', 'isNotEmptyOrKO' => 'Saisie obligatoire !',
		'isEqualKO' => 'La valeur saisie est différente de la valeur attendue', 'isEmailValidKO' => 'Cette adresse email est invalide',
		'matchExpressionKO.number' => "La valeur saisie n'est pas un nombre", 'isDateBeforeKO' => 'Cohérence des dates : date trop grande !',
		'isDateAfterKO' => 'Cohérence des dates : date trop petite !',
		'isNotContainsAtKO' => 'La valeur saisie contient un caractère interdit !',

		'doublon' => 'Cet identifiant est déjà utilisé !', 'NotEmpty.newLogin' => 'Un identifiant ne peut pas être vide !',
		...
		'isLowerThanKO.birthyear' => "Pas possible, c'est trop jeune !", 'isEqualKO.email' => 'Les emails ne correspondent pas !',
		...
		'doublon.name' => 'Ce prix existe déjà !', 'doublon.type' => 'Ce prix existe déjà !',

		'required-selection' => "Sélection obligatoire !", 'required-selection.title_docs' => "Sélectionnez au minimum un album !",
		...
		'none.awards' => 'Vous n\'êtes inscris à aucun prix !', 'nonePBD.awards' => 'Aucun prix trouvé !',
		'nonePSBD.awards' => 'Aucune présélection trouvée !', 'none.groups' => 'Vous n\'appartenez à aucun groupe !',
