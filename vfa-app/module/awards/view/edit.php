					...
					<div class="col-sm-6">
						<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'name') ?>">
							...
							<input class="form-control" type="text" id="inputName" name="name"
										 value="<?php echo $this->oAward->name ?>" autofocus/>
					...
					<div class="col-sm-6">
						<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'year') ?>">
							...
							<span class="btn btn-xs btn-link" data-rel="tooltip"
										data-original-title="L'année officlelle du prix à afficher.">
								<i class="glyphicon glyphicon-info-sign"></i>
							</span>
							</label>
							<input class="form-control" type="text" id="inputName" name="year"
										 value="<?php echo $this->oAward->year ?>"/>
						...
						<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'type') ?>">
							...
							<div>
								<label class="radio-inline" for="inputTypePrix">
									<input type="radio" id="inputTypePrix" name="type"
												 value="PBD" <?php if ('PBD' == $this->oAward->type): echo 'checked'; endif; ?> />
									Prix
								</label>
								<label class="radio-inline" for="inputTypeSelection">
									<input type="radio" id="inputTypeSelection" name="type"
												 value="PSBD" <?php if ('PSBD' == $this->oAward->type): echo 'checked'; endif; ?> />
									Présélection
								</label>
						...
						<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'public') ?>">
							...
							<div>
								<label class="radio-inline" for="inputPublic"> <input type="radio" id="inputPublic"
																																			name="public"
																																			value="1" <?php if ($this->oAward->public): echo 'checked'; endif; ?> />
									Public
								</label> <label class="radio-inline" for="inputPrivate"> <input type="radio"
																																								id="inputPrivate" name="public"
																																								value="0"
										<?php if (!$this->oAward->public): echo 'checked'; endif; ?> /> Privé
								</label> <span
									class="help-block"><?php echo plugin_validation::show($this->tMessage, 'public') ?></span>
							</div>
						</div>
					</div>
				</div>
