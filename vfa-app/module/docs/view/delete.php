<div class="panel panel-danger">
	<div class="panel-heading">
		<h3 class="panel-title"><i class="glyphicon glyphicon-trash with-text"></i>Supprimer un album</h3>
	</div>
	...
	<div class="panel-footer clearfix">
		<form action="" method="POST" >
			...
			<?php else :?>
				...
				<a class="btn btn-default pull-right" href="<?php echo $this->getLink('docs::index') ?>"><i class="glyphicon glyphicon-remove with-text"></i>Annuler</a>
			<?php endif;?>
		</form>
	</div>
</div>
