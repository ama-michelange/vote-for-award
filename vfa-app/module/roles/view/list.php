				...
				<tr>
					<?php if ($oRole->role_name != 'owner'): ?>
						...
						<td>
							<?php if (_root::getACL()->permit('roles::read')): ?>
								<a
									href="<?php echo $this->getLink('roles::read', array('id' => $oRole->getId())) ?>"><?php echo $oRole->role_name ?></a>
							<?php else : ?>
