<form action="" method="POST">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<div class="alert alert-warning clearfix">
				<p><?php echo plugin_validation::show($this->tMessage, 'token')?>
					<a class="btn btn-sm btn-warning pull-right" href="<?php echo $this->getLink(_root::getParamNav()) ?>">Fermer</a></p>
			</div>		
		</div>
		<?php else:?>
		<div class="panel-body panel-condensed">
			...
			<div class="panel panel-info panel-inner">
				<div class="panel-heading">
					<h3 class="panel-title">Pour l'inscription d'un <strong><?php echo plugin_vfa::makeSuffixTitleInvitation()?></strong></h3>
				</div>
				<div class="panel-body panel-condensed">
					<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, array('award_id','awards'))?>">
					...
					<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, array('group_id','groups')) ?>">
