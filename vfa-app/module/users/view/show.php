									...
									<td>
										<?php if(_root::getACL()->permit('groups::read')):?>
											<a href="<?php echo $this->getLink('groups::read',array('id'=>$oGroup->getId()))?>"
												rel="tooltip" data-original-title="Voir le groupe : <?php echo $oGroup->group_name ?>"><i	class="glyphicon glyphicon-eye-open with-text"></i></a>
										<?php endif;?>
									...
									<td>
										<?php if(_root::getACL()->permit('awards::read')):?>
											<a href="<?php echo $this->getLink('awards::read',array('id'=>$oAward->getId()))?>"
												rel="tooltip" data-original-title="Voir le prix : <?php echo $oAward->name ?>"><i	class="glyphicon glyphicon-eye-open with-text"></i></a>
										<?php endif;?>
										...
										<td>
											<?php if(_root::getACL()->permit('roles::read')):?>
												<a href="<?php echo $this->getLink('roles::read',array('id'=>$oRole->getId()))?>"
													rel="tooltip" data-original-title="Voir le role : <?php echo $oRole->role_name ?>"><i	class="glyphicon glyphicon-eye-open with-text"></i></a>
											<?php endif;?>
