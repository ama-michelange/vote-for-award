		...
		<div class="panel panel-info panel-inner">
			<div class="panel-body">
				<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'login') ?>">
					...
					<input class="form-control" type="text" id="inputLogin" name="loginDisabled" value="<?php echo $this->oUser->login ?>"
							 disabled/>
				...
				<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'email') ?>">
					...
					<input class="form-control" type="email" id="inputEmail" name="emailDisabled" value="<?php echo $this->oUser->email ?>"
							 disabled/>
