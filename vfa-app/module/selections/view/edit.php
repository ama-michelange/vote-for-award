		...
		<div class="panel-body">
			<div class="<?php echo plugin_validation::addClassError('form-group', $this->tMessage, 'name')?>">
				<label for="inputName">Nom
					...
					value="<?php echo $this->oSelection->name ?>" /> <span class="help-block"><?php echo plugin_validation::show($this->tMessage, 'name')?></span>
			</div>
<!--			<div class="row">-->
<!--				<div class="col-sm-6">-->
<!--					<div-->
...
<!--								name="type" value="PBD" --><?php //if('PBD'==$this->oSelection->type): echo 'checked'; endif; ?><!-- />-->
<!--								Prix-->
<!--							</label> <label class="radio-inline" for="inputTypeSelection"> <input type="radio"-->
<!--								id="inputTypeSelection" name="type" value="PSBD"-->
<!--								--><?php //if('PSBD'==$this->oSelection->type): echo 'checked'; endif; ?><!-- /> Présélection-->
...
<!--								name="public" value="1" --><?php //if($this->oSelection->public): echo 'checked'; endif; ?><!-- /> Public-->
<!--							</label> <label class="radio-inline" for="inputPrivate"> <input type="radio"-->
<!--								id="inputPrivate" name="public" value="0"-->
<!--								--><?php //if(!$this->oSelection->public): echo 'checked'; endif; ?><!-- /> Privé-->
...
<!--							name="start_date"-->
<!--							value="--><?php //echo plugin_vfa::toStringDateShow($this->oSelection->start_date) ?><!--" /> <span-->
...
<!--							value="--><?php //echo plugin_vfa::toStringDateShow($this->oSelection->end_date) ?><!--" /> <span-->
