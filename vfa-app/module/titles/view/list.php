		...
		<table class="table table-striped">
			...
			<?php foreach ($this->tTitles as $oTitle): ?>
				<tr>
							...
							<div class="btn-group">
								<?php if (_root::getACL()->permit('titles::update')): ?>
									<a class="btn btn-xs" rel="tooltip"
										 data-original-title="Modifier <?php echo $oTitle->title ?>"
										 href="<?php echo $this->getLink('titles::update', array('id' => $oTitle->getId())) ?>"> <i
											class="glyphicon glyphicon-edit"></i></a>
								<?php endif; ?>
								<?php if (_root::getACL()->permit('titles::delete')): ?>
									<a class="btn btn-xs" rel="tooltip"
										 data-original-title="Supprimer <?php echo $oTitle->title ?>"
										 href="<?php echo $this->getLink('titles::delete', array('id' => $oTitle->getId())) ?>"> <i
								...
								<?php if (_root::getACL()->permit('titles::read')): ?>
									<a class="btn btn-xs" rel="tooltip" data-original-title="Voir <?php echo $oTitle->title ?>"
										 href="<?php echo $this->getLink('titles::read', array('id' => $oTitle->getId())) ?>"> <i
					...
					<?php if (_root::getACL()->permit('titles::read')): ?>
						<td><a
								href="<?php echo $this->getLink('titles::read', array('id' => $oTitle->getId())) ?>"><?php echo $oTitle->title ?></a>
						</td>
					<?php else: ?>
