...
//			$cr = '<br/>';
        ...
        switch ($poInvitation->type) {
            case plugin_vfa::TYPE_BOARD:
                $textInvit = sprintf('%1$s, l\'organisateur des Prix Alice et Clochette, %2$s%2$svous invite à devenir membre du Comité de sélection.',
                    $creator, $cr);
                break;
            case plugin_vfa::TYPE_READER:
                $textInvit = sprintf('%1$s, le correspondant du Prix Alice et Clochette, %2$s%2$svous invite à participer au prix.', $creator,
                    $cr);
                break;
            case plugin_vfa::TYPE_RESPONSIBLE:
                $textInvit = sprintf('%1$s, l\'organisateur du Prix Alice et Clochette, %3$s%3$svous invite à devenir Correspondant du groupe %2$s %3$s%3$set à vous inscrire au prix.',
            ...
            case plugin_vfa::CATEGORY_INVITATION:
                switch ($poInvitation->type) {
                    case plugin_vfa::TYPE_BOARD:
                        ...
                        break;
                    case plugin_vfa::TYPE_READER:
                        $titleInvit .= 'Invitation pour voter au Prix Alice et Clochette';
                        break;
                    case plugin_vfa::TYPE_RESPONSIBLE:
                        $titleInvit .= 'Invitation pour devenir Correspondant de votre groupe et voter au Prix Alice et Clochette';
                        break;
                }
                break;
