...
class plugin_gestionuser
{
	 ...
	 * @return void
	 * @param string $action
	 *          action qu'on autorise sur $ressource
	 * @param string $ressource
	 *          ressource l'action est autorise sur $ressource
	 */
	 ...
	 * @return void
	 * @param string $action
	 *          action qu'on n'autorise pas sur $ressource
	 * @param string $ressource
	 *          ressource l'action est n'autorise pas sur $ressource
	 */
