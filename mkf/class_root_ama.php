...
class _root_ama
{
	...
	protected static $_oCacheVar;

	protected static $_oAuth;

	protected static $_oUrlrewriting;

	protected static $_oLog;

	protected static $_tConfigFilename;

	protected static $_tRequestTab;

	protected static $_tAutoload;

	protected static $_tConfigVar;

	protected static $_tGlobalVar;

	protected static $_tObject;

	protected static $_oACL;

	protected static $_bSessionStarted = 0;
