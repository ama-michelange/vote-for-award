<div class="well well-small alert clearfix">
	...
	<form class="form-horizontal" action="" method="POST" >
		...
		<a class="btn btn-success" href="<?php echo $this->getLink('titles::index') ?>"><i class="glyphicon glyphicon-remove glyphicon glyphicon-white"></i> Annuler</a>
		<?php else :?>
		<div class="alert alert-success clearfix">
			<a class="btn btn-success " href="<?php echo $this->getLink('titles::index') ?>"><i class="glyphicon glyphicon-remove glyphicon glyphicon-white"></i> Annuler</a>
			<strong>Suppression interdite !</strong> Ce titre est encore associé à un prix.
		</div>
		<?php endif;?>
	</form>
</div>
