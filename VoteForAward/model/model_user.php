...
class model_user extends abstract_model{
	...
	public function findAllByGroupId($pGroupId) {
		$sql = 'SELECT * FROM vfa_users, vfa_user_groups '
				.'WHERE (vfa_user_groups.user_id = vfa_users.user_id) '
						.'AND (vfa_user_groups.group_id = ?) '
								.'ORDER BY vfa_users.username';
	 ...
	 * @param String $pLogin Le login (ou username) unique dans la table
	 * @param String $pPass Le mot de passe crypté SHA1
